...
The badge color reflects what percentage of an LLMs context window the codebase fills (context window size is configurable, defaults to 2M which is the size of Gemini 1.5 Pro). Green for under 30%, yellow-green for 30%-50%, yellow for 50%-70%, red for 70%+.
...
| `context-window` | `2000000` | Context window size for percentage calculation |
